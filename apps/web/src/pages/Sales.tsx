...
registerNamespace('sales', {
  uz: {
    ...
    'kpi.revenueHint': 'Soatlik taqsimot yig‘indisi',
    'kpi.profitHint': 'Joriy sahifa marjasi bo‘yicha baholangan',
    'kpi.avgCheckHint': 'Tushum / buyurtmalar soni',
  ...
  ru: {
    ...
    'kpi.revenueHint': 'Сумма почасового распределения',
    'kpi.profitHint': 'Оценка по марже текущей страницы',
    'kpi.avgCheckHint': 'Выручка / количество заказов',
  ...
  en: {
    ...
    'kpi.revenueHint': 'Sum of the hourly breakdown',
    'kpi.profitHint': 'Estimated from the current page margin',
    'kpi.avgCheckHint': 'Revenue / order count',
