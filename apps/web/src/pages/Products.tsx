...
registerNamespace('products', {
  uz: {
    ...
    'card.avgPrice': 'O‘rtacha sotuv narxi',
    'card.listPrice': 'Katalog narxi',
    'card.promo': 'Aksiya',
    'card.promoUntil': '{date} gacha',
    'card.priceWhy':
      'Uzum ochiq API’da aksiyadagi joriy narxni bermaydi — katalogda faqat ro‘yxat narxi bo‘ladi. Shuning uchun bu yerda xaridorlar haqiqatda to‘lagan narxning davr bo‘yicha o‘rtachasi ko‘rsatiladi.',
    'card.cost': 'Tannarx',
  ...
  ru: {
    ...
    'card.avgPrice': 'Средняя цена продажи',
    'card.listPrice': 'Цена в каталоге',
    'card.promo': 'Акция',
    'card.promoUntil': 'до {date}',
    'card.priceWhy':
      'Открытый API Uzum не отдаёт текущую цену в акции — в каталоге только цена списка. Поэтому здесь средняя цена, которую покупатели фактически заплатили за период.',
  ...
  en: {
    ...
    'card.avgPrice': 'Average sale price',
    'card.listPrice': 'Catalogue price',
    'card.promo': 'Promo',
    'card.promoUntil': 'until {date}',
    'card.priceWhy':
      'The public Uzum API does not expose the current promo price — the catalogue only carries the list price. This figure is therefore the average buyers actually paid over the period.',
    'card.cost': 'Cost',
