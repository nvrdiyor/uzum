            ...
            {TOP_ROWS.map((r) => (
              <li key={r.sku} className="flex items-center gap-3">
                <span
                  className={
                    r.tone === 'brand'
                      ? 'flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-brand/12 text-brand'
                      : r.tone === 'info'
                        ? 'flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-info/12 text-info'
                        : 'flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-warn/12 text-warn'
                  }
                >
